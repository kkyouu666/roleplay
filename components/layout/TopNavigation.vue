  ...
  <header class="bg-white dark:bg-gray-800 shadow-sm z-30">
    <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700 relative">
        ...
        <div 
          ...
          class="flex-1 transition-all duration-300 mx-4"
          :class="{ 
        ...
        >
          <div class="relative flex items-center">
            ...
            <button 
              class="md:hidden absolute left-0 p-2"
        ...
        <!-- Right Actions -->
        <div 
          class="flex items-center space-x-4 transition-all duration-300 flex-shrink-0"
          ...
          <div v-if="authStore?.isAuthenticated" class="relative" ref="userMenuRef">
            ...
            >
              <img 
                ...
                :src="authStore?.user?.profileImage || '/images/avatars/default.jpg'"
                alt="User profile"
              />
            </button>
...
function toggleNotifications() {
  ...
  if (!isNotificationsPage.value) {
    ...
    // If on notifications page, just make sure to close panel
    showNotifications.value = false;
  }
}
