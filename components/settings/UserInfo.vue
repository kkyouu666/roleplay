      ...
      <div class="mb-6">
        <div class="flex items-center justify-center mb-4">
          <div class="relative">
            ...
            <div v-if="!modelValue.profileImage" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="md:col-span-2">
            ...
            <textarea
              ...
              maxlength="500"
            ></textarea>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ modelValue.bio ? modelValue.bio.length : 0 }}/500</p>
          </div>
        </div>
      </div>
