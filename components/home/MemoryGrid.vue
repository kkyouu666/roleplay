            ...
            <div v-for="memory in memories" :key="memory.id"
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-2">
                        <h3 class="font-medium text-gray-900 dark:text-gray-100">{{ memory.title || 'Chat Memory' }}
                        </h3>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <NuxtLink :to="`/users/${memory.user.id}`" class="flex items-center">
                                ...
                                <span
                                    class="ml-1 text-xs text-gray-700 dark:text-gray-300">{{ memory.user.username }}</span>
                            </NuxtLink>
                        </div>

                        <div class="flex items-center">
                            <span
                                class="text-xs text-gray-700 dark:text-gray-300 mr-1">{{ memory.character?.name }}</span>
